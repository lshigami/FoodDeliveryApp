  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: TextHint,
        hintStyle: TextStyle(
            fontFamily: FontStyle, fontSize: 16, color: Colours.fieldText),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: BigText(
                      text:
                          "You can now oder from multiple\nrestaurants at the same time!",
                      FontType: Fonts.Roboto,
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: BigText(
                      text:
                          "Left over food and supplies are\ngathered and are sold for 50% off!",
                      FontType: Fonts.Roboto,
                      FontWeight: FontWeight.w400,
                      Size: 13.0,
                      Color: Colors.white),
          ...
          Column(
            children: [
              Image(
                image: AssetImage(ImageRes.tag2),
                width: 130,
                height: 87,
              ),
              Padding(
