...
class BreakfastCate extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('MenuItem')
            .where('Category', isEqualTo: 'Breakfast') // Filter by category
            .snapshots(),
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Text('No breakfast items available.');
          }
